...
Rounded **mean** of the total steps per day: **`r mean.ts`**  
Rounded **median** of the total steps per day: **`r median.ts`**    
...
Rounded maximum number of steps on average in that interval: **`r max.avg.steps.value`**  
...
Rounded **mean** of the total steps on a dataset with imputed values: **`r mean.ts.full`**  
Rounded **median** of the total steps on a dataset with imputed values: **`r median.ts.full`**    
